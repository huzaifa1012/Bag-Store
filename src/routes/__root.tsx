...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Carryon — Premium Laptop Bags" },
      { name: "twitter:description", content: "Shop premium laptop bags — backpacks, sleeves and briefcases engineered for professionals." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/72ba8eda-9bf4-4feb-b903-943ad2a84562/id-preview-0a06c4fa--a2d37bdb-5d4b-4460-9f80-a2713aaaa996.lovable.app-1785188305362.png" },
